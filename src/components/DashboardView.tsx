        ...
        <div className="xl:col-span-3 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div
              ...
              className="bg-white p-4 rounded-xl border border-slate-200/90 shadow-xs hover:shadow-md transition cursor-pointer flex items-center justify-between"
            >
              <div className="space-y-1">
                ...
                <p className="text-[11px] text-slate-400">Assigned to you</p>
              </div>
            </div>
            ...
            >
              <div className="space-y-1">
                ...
                <p className="text-[11px] text-emerald-600 font-medium">{completionRate}% completion rate</p>
              </div>
            </div>
            ...
            >
              <div className="space-y-1">
                ...
                <p className="text-[11px] text-slate-400">Active interviews</p>
              </div>
            </div>
            ...
            >
              <div className="space-y-1">
                <div className="w-10 h-10 rounded-lg bg-slate-100 text-slate-600 flex items-center justify-center mb-2">
                ...
                <p className="text-[11px] text-slate-400">Saved, not submitted</p>
              </div>
            </div>
          </div>
