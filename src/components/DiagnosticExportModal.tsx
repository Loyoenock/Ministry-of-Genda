      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col border border-slate-200">
        ...
        <div className="p-4 bg-slate-900 text-white flex items-center justify-between rounded-t-2xl print:hidden">
          <div className="flex items-center space-x-2 text-xs font-bold">
            ...
            <span>Official Ministry Diagnostic Brief Preview</span>
          </div>
          <div className="flex items-center space-x-3">
            <button
              onClick={handlePrint}
              className="px-3 py-1.5 bg-teal-600 hover:bg-teal-500 text-white rounded-lg text-xs font-bold flex items-center space-x-1.5 transition"
            >
              <Printer className="w-4 h-4" />
              <span>Print Diagnostic Brief</span>
            </button>
        ...
        <div className="p-8 overflow-y-auto space-y-6 text-slate-800 bg-white font-serif print:p-0">
          {/* Official Letterhead */}
